...
public class FinancialIndicatorsCalculator {
    ...
    public FinancialIndicators calculate(BigDecimal financedAmount,
        ...
        return new FinancialIndicators(
                ...
                MoneyMath.money(initialChargesFinanced),
                MoneyMath.money(initialChargesPaidUpfront),
                MoneyMath.money(initialChargesWithheld),
                MoneyMath.money(cashAtSigning),
                MoneyMath.money(totalAdditionalCharges),
                MoneyMath.money(totalPeriodicCharges),
                MoneyMath.money(balloonAmount),
